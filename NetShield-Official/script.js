...
window.onload = function(){
  ...
  let front5 = `<img src="images/logo.png" style="width:200px;height:200px;box-shadow: 0 5px 15px rgb(255, 255, 255, 0.2);">`;
  let back5 = `<img src="images/logo.png" style="width:200px;height:200px;box-shadow: 0 5px 15px rgb(255, 255, 255, 0.2);">`;    
